...
const predict = () => {
  // Rules field outputs
  let str = fs.readFileSync(path.join(__dirname, "node_modules", "eslint-generator", "data_files", "rules.csv"), "utf-8");
  ...
  // Load ML model
  tf.loadLayersModel(
    "file://" + __dirname + "node_modules/eslint-generator/mymodel/model.json"
  ).then(model => {
